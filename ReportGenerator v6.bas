...
outsider2 = InputBox("SECOND OUTSIDER OPTIONAL: If making two reports, please enter another abbreviated code name of the B & L outsider if you wish the report be made for: ", "OPTIONAL: Enter code name", "TS")
...
If outsider2 <> "" Then
    ...
    If IsEmpty(ws2.Range("F8").Value) Then ws2.Range("F1").EntireColumn.Hidden = True
    If IsEmpty(ws2.Range("G8").Value) Then ws2.Range("G1").EntireColumn.Hidden = True
    If IsEmpty(ws2.Range("H8").Value) Then ws2.Range("H1").EntireColumn.Hidden = True
    
    If IsEmpty(ws2.Range("P8").Value) Then ws2.Range("P1").EntireColumn.Hidden = True
    If IsEmpty(ws2.Range("Q8").Value) Then ws2.Range("Q1").EntireColumn.Hidden = True
    If IsEmpty(ws2.Range("R8").Value) Then ws2.Range("R1").EntireColumn.Hidden = True
End If
