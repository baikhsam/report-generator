...
ask_month = InputBox("Enter the month this report is for: ", "Enter month", "June")
...
outsider2 = InputBox("SECOND OUTSIDER OPTIONAL: Please enter another abbreviated code name of the B & L outsider you wish the report be made for: ", "OPTIONAL: Enter code name", "B326")
...
If outsider1 <> "" Then
    Do While copysheet.Cells(i, 1).Value <> ""
        If copysheet.Range("M" & row) <> outsider1 Then
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FF" Then
            holder = copysheet.Range("O" & row)
            
            ws.Range("D7") = holder
            'Cells(i, 4).Value = holder
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FFF" Then
            holder = copysheet.Range("O" & row)
            ws.Range("E7") = holder * -1
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 Then
            holder = copysheet.Range("O" & row)
            ...
            End If
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider1 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "FF" Then
...
If outsider2 <> "" Then
    Do While copysheet.Cells(i, 1).Value <> ""
        If copysheet.Range("M" & row) <> outsider2 Then
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FF" Then
            
            holder = copysheet.Range("O" & row)
            ws2.Range("D7") = holder
            'Cells(i, 4).Value = holder
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FFF" Then
            
            holder = copysheet.Range("O" & row)
            
            ws2.Range("E7") = holder * -1
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "FF" Then
            ...
            End If
            row = row + 1
        ElseIf copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider2 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "FF" Then
                ...
                ws2.Range("M" & drow) = copysheet.Range("AE" & row)
...
'Hide blank rows
If outsider1 <> "" Then ws.Range("A31:A99").AutoFilter 1, "<>", , , False
If outsider2 <> "" Then ws2.Range("A31:A99").AutoFilter 1, "<>", , , False
ws.Activate
