...
If outsider1 <> "" Then
    Do While copysheet.Cells(i, 1).Value <> ""
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FF" Then
            ...
            ws.Range("D7") = Format(holder, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FFF" Then
            holder = copysheet.Range("O" & row)
            ws.Range("E7") = Format(holder * -1, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 Then
            ...
            If copysheet.Range("J" & row) = "FF" Then
                ws.Range("D" & wrow) = Format(holder, "Standard")
            ...
            If copysheet.Range("J" & row) = "FFF" Then
                ws.Range("E" & wrow) = Format(holder, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider1 Then
            ...
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "FF" Then
                ws.Range("K" & drow) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "FFF" Then
                ws.Range("L" & drow) = Format(holder, "Standard")
...
If outsider1 <> "" Then
    ...
    Do While copysheet.Cells(i, 1).Value <> ""
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "F" Then
            holder = copysheet.Range("O" & row)
            ws.Range("F7") = Format(holder, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "G" Then
            holder = copysheet.Range("O" & row)
            ws.Range("G7") = Format(holder * -1, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "LG" Then
            holder = copysheet.Range("O" & row)
            ws.Range("H7") = Format(holder, "Standard")
            If ws.Range("H7") < 0 Then ws.Range("H7").Font.Color = vbRed
            row = row + 1
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider1 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "F" Then
                ws.Range("F" & row_holder) = Format(holder, "Standard")
            ...
            If copysheet.Range("J" & row) = "G" Then
                ws.Range("G" & row_holder) = Format(holder, "Standard")
            ...
            If copysheet.Range("J" & row) = "LG" Then
                ws.Range("H" & row_holder) = Format(holder, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider1 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "F" Then
                ws.Range("P" & row_holder) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "G" Then
                ws.Range("Q" & row_holder) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "LG" Then
                ws.Range("R" & row_holder) = Format(holder, "Standard")
...
If outsider2 <> "" Then
    ...
    Do While copysheet.Cells(i, 1).Value <> ""
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FF" Then
            holder = copysheet.Range("O" & row)
            ws2.Range("D7") = Format(holder, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "FFF" Then
            holder = copysheet.Range("O" & row)
            ws2.Range("E7") = Format(holder * -1, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 Then
            ...
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "FF" Then
                ws2.Range("D" & wrow) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "FFF" Then
                ws2.Range("E" & wrow) = Format(holder, "Standard")
                If ws2.Range("D" & wrow) < 0 Then ws2.Range("D" & wrow).Font.Color = vbRed
                ws2.Range("A" & wrow) = Format(CDate(copysheet.Range("I" & row)), "Medium Date")
                ws2.Range("B" & wrow) = copysheet.Range("H" & row)
                ws2.Range("F" & wrow) = copysheet.Range("AE" & row)
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider2 Then
            ...
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "FF" Then
                ws2.Range("K" & drow) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "FFF" Then
                ws2.Range("L" & drow) = Format(holder, "Standard")
...
If outsider2 <> "" Then
    ...
    Do While copysheet.Cells(i, 1).Value <> ""
        ...
        If copysheet.Range("M" & row) <> outsider2 Or month_track <> month_track2 Then
            row = row + 1
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "F" Then
            holder = copysheet.Range("O" & row)
            ws2.Range("F7") = Format(holder, "Standard")
            If ws2.Range("F7") < 0 Then ws2.Range("F7").Font.Color = vbRed
            row = row + 1
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "G" Then
            holder = copysheet.Range("O" & row)
            ws2.Range("G7") = Format(holder * -1, "Standard")
            If ws2.Range("G7") < 0 Then ws2.Range("G7").Font.Color = vbRed
            row = row + 1
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 And copysheet.Range("H" & row) = "OPENING STOCK" And copysheet.Range("J" & row) = "LG" Then
            holder = copysheet.Range("O" & row)
            ws2.Range("H7") = Format(holder, "Standard")
            If ws2.Range("H7") < 0 Then ws2.Range("H7").Font.Color = vbRed
            row = row + 1
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "OUT" And copysheet.Range("M" & row) = outsider2 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "F" Then
                ws2.Range("F" & row_holder) = Format(holder, "Standard")
                If ws2.Range("F" & row_holder) < 0 Then ws2.Range("F" & row_holder).Font.Color = vbRed
                ws2.Range("A" & row_holder) = Format(CDate(copysheet.Range("I" & row)), "Medium Date")
                ws2.Range("B" & row_holder) = copysheet.Range("H" & row)
                ws2.Range("I" & row_holder) = copysheet.Range("AE" & row)
                
                row_list_track = row_list_track + 1
            End If
            If copysheet.Range("J" & row) = "G" Then
                ws2.Range("G" & row_holder) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "LG" Then
                ws2.Range("H" & row_holder) = Format(holder, "Standard")
        ...
        ElseIf (month_track = month_track2) And copysheet.Range("N" & row) = "IN" And copysheet.Range("M" & row) = outsider2 Then
            holder = copysheet.Range("O" & row)
            If copysheet.Range("J" & row) = "F" Then
                ws2.Range("P" & row_holder) = Format(holder, "Standard")
                If ws2.Range("P" & row_holder) < 0 Then ws2.Range("P" & row_holder).Font.Color = vbRed
                ws2.Range("L" & row_holder) = Format(CDate(copysheet.Range("I" & row)), "Medium Date")
                ws2.Range("M" & row_holder) = copysheet.Range("H" & row)
                ws2.Range("S" & row_holder) = copysheet.Range("AE" & row)
                
                row_list_track = row_list_track + 1
            End If
            If copysheet.Range("J" & row) = "G" Then
                ws2.Range("Q" & row_holder) = Format(holder, "Standard")
            ...
            End If
            If copysheet.Range("J" & row) = "LG" Then
                ws2.Range("R" & row_holder) = Format(holder, "Standard")
    ...
    'Adding comma format to Total cells
    ws2.Range("R100") = Format(ws2.Range("R100"), "Standard")
    ws2.Range("Q100") = Format(ws2.Range("Q100"), "Standard")
    ws2.Range("P100") = Format(ws2.Range("P100"), "Standard")
    ws2.Range("F100") = Format(ws2.Range("F100"), "Standard")
    ws2.Range("G100") = Format(ws2.Range("G100"), "Standard")
    ws2.Range("H100") = Format(ws2.Range("H100"), "Standard")
    ws2.Range("D100") = Format(ws2.Range("D100"), "Standard")
    ws2.Range("E100") = Format(ws2.Range("E100"), "Standard")
    ws2.Range("N100") = Format(ws2.Range("N100"), "Standard")
    ws2.Range("O100") = Format(ws2.Range("O100"), "Standard")
    
    ws2.Range("D106") = Format(ws2.Range("D106"), "Standard")
    ws2.Range("D107") = Format(ws2.Range("D107"), "Standard")
    ws2.Range("D108") = Format(ws2.Range("D108"), "Standard")
    
    ws2.Range("E106") = Format(ws2.Range("E106"), "Standard")
    ws2.Range("E107") = Format(ws2.Range("E107"), "Standard")
    ws2.Range("E108") = Format(ws2.Range("E108"), "Standard")
    
    ws2.Range("F106") = Format(ws2.Range("F106"), "Standard")
    ws2.Range("F107") = Format(ws2.Range("F107"), "Standard")
    ws2.Range("F108") = Format(ws2.Range("F108"), "Standard")
    
    ws2.Range("G106") = Format(ws2.Range("G106"), "Standard")
    ws2.Range("G107") = Format(ws2.Range("G107"), "Standard")
    ws2.Range("G108") = Format(ws2.Range("G108"), "Standard")
    
    ws2.Range("H106") = Format(ws2.Range("H106"), "Standard")
    ws2.Range("H107") = Format(ws2.Range("H107"), "Standard")
    ws2.Range("H108") = Format(ws2.Range("H108"), "Standard")
...
If outsider1 <> "" Then
    ...
    'Adding comma format to Total cells
    ws.Range("R100") = Format(ws.Range("R100"), "Standard")
    ws.Range("Q100") = Format(ws.Range("Q100"), "Standard")
    ws.Range("P100") = Format(ws.Range("P100"), "Standard")
    ws.Range("F100") = Format(ws.Range("F100"), "Standard")
    ws.Range("G100") = Format(ws.Range("G100"), "Standard")
    ws.Range("H100") = Format(ws.Range("H100"), "Standard")
    ws.Range("D100") = Format(ws.Range("D100"), "Standard")
    ws.Range("E100") = Format(ws.Range("E100"), "Standard")
    ws.Range("N100") = Format(ws.Range("N100"), "Standard")
    ws.Range("O100") = Format(ws.Range("O100"), "Standard")
    
    ws.Range("D106") = Format(ws.Range("D106"), "Standard")
    ws.Range("D107") = Format(ws.Range("D107"), "Standard")
    ws.Range("D108") = Format(ws.Range("D108"), "Standard")
    
    ws.Range("E106") = Format(ws.Range("E106"), "Standard")
    ws.Range("E107") = Format(ws.Range("E107"), "Standard")
    ws.Range("E108") = Format(ws.Range("E108"), "Standard")
    
    ws.Range("F106") = Format(ws.Range("F106"), "Standard")
    ws.Range("F107") = Format(ws.Range("F107"), "Standard")
    ws.Range("F108") = Format(ws.Range("F108"), "Standard")
    
    ws.Range("G106") = Format(ws.Range("G106"), "Standard")
    ws.Range("G107") = Format(ws.Range("G107"), "Standard")
    ws.Range("G108") = Format(ws.Range("G108"), "Standard")
    
    ws.Range("H106") = Format(ws.Range("H106"), "Standard")
    ws.Range("H107") = Format(ws.Range("H107"), "Standard")
    ws.Range("H108") = Format(ws.Range("H108"), "Standard")
